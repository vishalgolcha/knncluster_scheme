...
(define reader (cdr (file->lines "t0.in")))
(define fline (car (file->lines "t0.in")))
...
(define  step2inp (cdr (line_extr "t0.in" )) )  
...
(define dist_ord  (sorted_mat matrix_out  '() (length matrix_out  )))
